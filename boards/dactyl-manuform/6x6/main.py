...
LOWER = KC.MO(1)
RAISE = KC.MO(2)
RGBSWRL = KC.RGB_MODE_SWIRL
RGBTOG = KC.RGB_TOG
RGBBRTH = KC.RGB_MODE_BREATHE
...
keyboard.keymap = [
    ...
    [    
        ...
        KC.LCBR,KC.RCBR,KC.ENT, KC.SPC, KC.SPC, LOWER,       RAISE,  KC.BSPC,KC.DEL, PASTE,
                        KC.BSPC,RGBSWRL,RGBTOG, KC.DEL,      KC.DEL, RGBBRTH,RGBKNT, RGBBOW,
    ],
    # LOWER
    [           
        ...
        _______, RGBSWRL, RGBBBW,  RGBBOW ,KC.RGB_HUD,_______,   _______,KC.RGB_HUI,RGBTOG, RGBKNT , RGBBRTH, RGBKNT, 
